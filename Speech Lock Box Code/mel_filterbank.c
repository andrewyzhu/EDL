...
#define filter_Mel_high_edge (double)(1873.13373404) //conversion of 3000 Hz to Mels, The maximum frequency we can accurately sample is 3000 Hz. As our sampling frequency is 6000 Hz
#define filter_width (double)(68.2015) //we want 26 filters that are evenly distributed on the Mel scale from 31.6922 to 1873.13373404
